<template>
    <span>
        <a href="javascript:;" @click="refreshResource" class="cursor-pointer text-70 hover:text-primary">
            <svg height="24px" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<script>
    export default {
        ...
        methods: {
            refreshResource() {
                this.$toasted.show(
                    this.__('Resource should be refreshed now!'),
                    {type: 'success'}
                );
